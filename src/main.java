...
public class main {
    public static void main(String[] args) {
        ...
        System.out.print("initialisation du vecteur01");//initialisation du vecteur 01
        ...
        System.out.print("\n inversion du vecteur 01 :"); //inverser le vecteur 01
        VectorHelper.afficher_vector(vec1);
        System.out.print("\n Trier le vecteur01 ");  //trier le vecteur 01
        VectorHelper.trier_vector(vec1);
        VectorHelper.afficher_vector(vec1);
        System.out.print("\n min et max du vecteur01: "); //trouver le min et max du vecteur
        VectorHelper.min_max(vec1,min_max);
        System.out.print("\n le min est : "+min_max.elementAt(0)+" \n le max est : "+min_max.elementAt(1));
        System.out.print("\n application de la formule pour le vecteur01:  "); //applicaion de la formuler 01
